...
def test_setting_values_with_object_attributes():
    ...
    settings.epochs_ShapeAE = _params['epochs_ShapeAE']
    settings.epochs_cShapeAE = _params['epochs_cShapeAE']
    ...
    assert settings.epochs_ShapeAE == _params['epochs_ShapeAE']
    assert settings.epochs_cShapeAE == _params['epochs_cShapeAE']    
